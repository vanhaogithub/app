...
public class SalaryConverter {
	...
	public SalaryOutDTO toOutDTO(SalaryDTO salaryDTO) {
		...
		dto.setOtAmount(stringUtils.doubleToString(salaryDTO.getOtAmount()));
		dto.setTimesLeave(salaryDTO.getTimesLeave());
		dto.setStatusLeave(salaryDTO.getStatusLeave());
		dto.setLeaveDayAmount(stringUtils.doubleToString(salaryDTO.getLeaveDayAmount()));
		dto.setIsDelay(salaryDTO.getIsDelay());
		dto.setDelayAmount(stringUtils.doubleToString(salaryDTO.getDelayAmount()));
		dto.setDaySalaryAmount(stringUtils.doubleToString(salaryDTO.getDaySalaryAmount()));
		dto.setDayBonusAmount(stringUtils.doubleToString(salaryDTO.getDayBonusAmount()));
		dto.setDaySalary(stringUtils.doubleToString(salaryDTO.getDaySalary()));
